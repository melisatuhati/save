...
options = {
    'proxy': {
        'http': 'http://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10192',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/a7841f91-dc88-4a50-bac0-13368fb6a478")
time.sleep(50000)
