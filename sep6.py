...
options = {
    'proxy': {
        ...
        'https': 'http://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10157',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/d3b8c5cc-57d1-49b5-ac93-42c5b414665a")
time.sleep(50000)
