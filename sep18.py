...
options = {
    'proxy': {
        'http': 'http://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10183',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/3e83283a-832c-4a8a-9776-2201dd0bc2f5")
time.sleep(50000)
