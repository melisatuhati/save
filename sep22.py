...
options = {
    'proxy': {
        'http': 'http://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10154',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/5c2b2192-6bb7-4602-9b88-486912f32b72")
time.sleep(50000)
